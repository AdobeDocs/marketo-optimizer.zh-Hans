...
在可视化设计空间中使用内容时，可以使用导航树访问组件、列和内容元素。 单击左侧的&#x200B;_[!UICONTROL 导航树]_&#x200B;图标（![导航树图标](../user-guide/assets/do-not-localize/icon-navigation-tree.svg)）以显示该树。

![访问内容层](../user-guide/content/assets/content-design-layers.png){width="800" zoomable="yes"}
...
1. 在列工具栏中，单击&#x200B;_[!UICONTROL 选择列]_&#x200B;工具，然后选择要编辑的工具。
   ...
   可视化设计器中显示的![列组件](../user-guide/content/assets/content-design-layers-column-select.png){width="800" zoomable="yes"}
...
1. 要编辑列属性，请单击右侧的&#x200B;_[!UICONTROL 样式]_&#x200B;选项卡，然后根据需要进行更改：
   ...
   * 展开&#x200B;**[!UICONTROL 高级]**&#x200B;部分以定义列的内联样式。
   ...
   ![更改选定列的样式](../user-guide/content/assets/content-design-layers-column-styles.png){width="700" zoomable="yes"}
