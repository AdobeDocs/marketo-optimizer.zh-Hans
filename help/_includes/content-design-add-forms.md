...
1. 在&#x200B;**[!UICONTROL 内容]**&#x200B;部分下，将&#x200B;**[!UICONTROL 表单]**&#x200B;项拖放到页面设计空间上的某个结构组件中。
   ...
   ![将表单组件拖动到可视设计空间](../user-guide/content/assets/content-design-add-form.png){width="600"}

   >[!TIP]
   >
   >要添加表单，使其占据页面内的整个水平布局，请添加1:1列结构，然后将表单拖放到其中。

1. 单击组件工具栏中的&#x200B;_表单_&#x200B;图标，或使用右侧的&#x200B;**[!UICONTROL 嵌入表单]**&#x200B;属性选择发布的表单。

   ![选择已发布的表单](../user-guide/content/assets/content-design-add-form-properties.png){width="600"}
...
1. 如果要覆盖表单的默认&#x200B;**[!UICONTROL 跟进类型]**，请根据页面或模板的要求更改设置。
   ...
   * **[!UICONTROL 外部URL]** — 选择此选项可将任何URL指定为后续页面。 访客提交表单后，浏览器会加载指定的URL。
     ...
     ![更改跟进设置](../user-guide/content/assets/content-design-add-form-follow-up.png){width="280"}
